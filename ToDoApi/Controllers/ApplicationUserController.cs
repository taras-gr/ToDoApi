...
namespace ToDo.Api.Controllers
{
    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        public ApplicationUserController(IUserService userService, IOptions<ApplicationSettings> appSettings)
        {
        ...
        public async Task<ActionResult> PostApplicationUser([FromBody]ApplicationUserModel model)
        {
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError, "Something bad");
            }
        }
